...
<form action="process.php" method="post">
  ...
  <table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0">
    <tbody>
      <tr>
        <td style="vertical-align: top; text-align: center;"><a href="User_Club_Login.php"><img style="border: 0px solid ; width: 288px; height: 197px;" alt="" src="Photos/dance-club.jpg"></a><br>
        </td>
